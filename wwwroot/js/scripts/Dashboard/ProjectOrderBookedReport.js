...
$.post('GetProjectOrderBookedReport', { strKey: null }).done(function (resultData) {
    debugger;
        ...
        var barChartData = {
            ...
            datasets: [
              ...
              },
              {
                  ...
                  data: resultData.currentMonthData
              }
              ,
              {
                  ...
                  pointHighlightFill: '#fff',
                  pointHighlightStroke: 'rgba(60,141,188,1)',
                  data: resultData.uptoCurrentMonthData
              }
            ]
        }
...
$('#period').change(function (objEdit) {
    debugger;
    $.post('GetProjectOrderBookedReport', { strDivision: $(this).val() }).done(function (resultData) {
        debugger;
        if (resultData != null && resultData != undefined) {
            var barChartData = {
                labels: resultData.labelData,
