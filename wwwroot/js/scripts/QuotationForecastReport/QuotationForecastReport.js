...
$("#formQuoteForecastReport").validate({
...
$("#btnSubmit").click(function () {
    ...
    $("#Division").val($("#DivisionID").val());
    $("#Branch").val($("#BranchID").val());
    var validator = $("#formQuoteForecastReport").validate();
    var isValid = validator.form();
    var data = $("#formQuoteForecastReport").serialize();

    if (isValid) {
        $.post('GetQuoteReportChart', data).done(function (resultData) {
            debugger;
...
$("#btnExport").click(function () {
    ...
    if ($('#DateFrom').val() == null && $('#DateTo').val() == null) {
        ...
        $("#formQuoteForecastReport").submit();
    }
