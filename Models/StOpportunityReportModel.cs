...
{
    public class StOpportunityReportModel
    {

    }

    public class StOpportunityReportSearchModel
    {
    ...
    public class StOpportunityReportChartModel
    {
        public List<string> labelData { get; set; }
        public List<double?> monthData { get; set; }
    }
    public class StOpportunityReportExport
    {
        public string Division { get; set; }
